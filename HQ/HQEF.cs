...
#endif
#if (Pruebas)
                       : base("data source=10.10.1.15;initial catalog=hqdata;persist security info=True;user id=sa;password=colonial@20001;MultipleActiveResultSets=True;App=EntityFramework")
